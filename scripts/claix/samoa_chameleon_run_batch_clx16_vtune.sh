...
export LB_SETTINGS="-lbfreq 100000" 	# w/o load balancing
...
export SAMOA_VTUNE_PREFIX="amplxe-cl –collect hotspots –r ./profiling_packing_${OMP_NUM_THREADS} -- "
source samoa_run_normal.sh
export SAMOA_VTUNE_PREFIX="amplxe-cl –collect hotspots –r ./profiling_chameleon_${OMP_NUM_THREADS} -- "
source samoa_run_chameleon.sh
export SAMOA_VTUNE_PREFIX="amplxe-cl –collect hotspots –r ./profiling_tool_${OMP_NUM_THREADS} -- "
