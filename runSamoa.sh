...
bin/samoa_${order}_all -tmax $t_max -dmin $i_min -dmax $i_max -tout 0.1 -output_dir $output -drytolerance 0.000001 -dry_dg_guard 0.01 -coastheight 0.025 -xmlpointoutput -sections 1 -max_picard_iterations 20 -max_picard_error 10.0d-12 -limiter_buffer 0.1d0 -courant 0.05
